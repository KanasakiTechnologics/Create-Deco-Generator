...
public class MoltenGoldType extends FluidType {
    private static final ResourceLocation STILL = ResourceLocation.fromNamespaceAndPath("decobuild", "block/molten_gold_still");
    private static final ResourceLocation FLOWING = ResourceLocation.fromNamespaceAndPath("decobuild", "block/molten_gold_flow");

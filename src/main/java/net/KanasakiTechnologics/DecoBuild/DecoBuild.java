package net.KanasakiTechnologics.DecoBuild;
...
@Mod(DecoBuild.MOD_ID)
public class DecoBuild {
    public static final String MOD_ID = "decobuild";
    public static final Logger LOGGER = LogUtils.getLogger();

    public DecoBuild(IEventBus modEventBus, ModContainer modContainer) {
        modEventBus.addListener(this::commonSetup);
        NeoForge.EVENT_BUS.register(this);

        DecoFluidType.register(modEventBus);
        DecoFluid.register(modEventBus);
        DecoItems.register(modEventBus);
        DecoBlocks.register(modEventBus);
        DecoCreativeTab.register(modEventBus);
    ...
    @EventBusSubscriber(modid = DecoBuild.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
